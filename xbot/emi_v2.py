...
def emi_create(emi_name):
    ...
    p1=Popen(['avdmanager','create','avd','-n',emi_name,'-k','system-images;android-30;google_apis_playstore;x86_64','-f',"--device","19","--sdcard","1024M"],stdin=echono.stdout,env=env)
    p1.wait()
